...
import { videoProcessingController } from "./useVideoProcessing"
 ...
 */
export default function useVideoEditorResume() {
  ...
  const resumeBatchLoading = useCallback(() => {
    videoProcessingController.startBatchLoading(beeClient, gatewayClient, gatewayType, batchId)
  }, [batchId, beeClient, gatewayClient, gatewayType])

  const resumeUpload = useCallback(() => {
    videoProcessingController.resumeUpload()
  }, [])
