...
declare module "react-rte" {
  ...
  type CustomInlineFn = (element: Element, inlineCreators: InlineCreators) => undefined | null | Style | draftjs.EntityInstance
  ...
  export type CustControlFunc = (set: SetControlState, get: GetControlState, state: EditorState) => ReactNode
