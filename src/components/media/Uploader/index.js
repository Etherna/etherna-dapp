...
const Uploader = ({ isLoggedIn, channelName, channelAvatar, currentAddress }) => {
    ...
    if (!isLoggedIn) {
        return <p className="text-lg text-gray-700 text-center my-16">You must log in first.</p>
    }
            ...
            <div className="row">
                ...
                <div className="col step-col sm:w-1/2">
                    <ul className="upload-steps mb-4">
                        <li className={classnames("upload-step", { "step-done": videoHash !== undefined })}>Upload a video</li>
                        <li className={classnames("upload-step", { "step-done": title !== '' })}>Add a title</li>
                        <li className={classnames("upload-step", { "step-done": description !== '' })}>Add a description</li>
                    </ul>
                    <Button disabled={
                        videoHash === undefined ||
                        title === '' ||
