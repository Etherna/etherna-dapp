...
import classes from "@styles/components/media/VideoEncoder.module.scss"
...
const VideoEncoder: React.FC<VideoEncoderProps> = ({
  ...
  return (
    <>
      {!canEncode && (
        <p className={classes.videoEncoderText}>Pending encoding...</p>
      )}
      {isEncoding && (
        <div className={classes.videoEncoder}>
          <p className={classes.videoEncoderText}>
