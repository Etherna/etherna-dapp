  ...
  return (
    <div className="video-rating">
      <div className="video-rating-buttons">
        <button className="video-rating-btn rating-up" onClick={giveThumbsUp} disabled={isUpdatingVote}>
          <span className="thumb-icon">
            <ThumbUpIcon />
          </span>
          <span className="counter">{shortNumber(currentUpvotes)}</span>
        </button>
        <button className="video-rating-btn rating-down" onClick={giveThumbsDown} disabled={isUpdatingVote}>
          <span className="thumb-icon">
            <ThumbUpIcon />
          </span>
